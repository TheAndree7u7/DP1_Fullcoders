...
/**
 * DTO para la creación de una nueva avería con estado completo de la simulación.
 * Esta clase incluye tanto los datos básicos de la avería como el estado completo
