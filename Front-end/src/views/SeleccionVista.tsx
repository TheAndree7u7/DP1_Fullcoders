...
const SeleccionVista: React.FC = () => {
  ...
  return (
    <div className="bg-[#F5F5F5] w-screen h-screen flex flex-col">
      <Navbar title="Selección de Escenarios" />
      <div className="flex flex-col flex-1 p-8 justify-center items-center">
        ...
        <div className="flex gap-6">
          ...
          >
            ...
            <img src={diarioImg} alt="Ejecución en tiempo Real" className="w-auto h-32 object-cover rounded" />
          </div>
          <div
          ...
          >
            ...
            <img src={semanalImg} alt="Simulación semanal" className="w-auto h-32 object-cover rounded" />
          </div>
          <div
          ...
          >
            ...
            <img src={colapsoImg} alt="Colapso Logístico" className="w-auto h-32 object-cover rounded" />
          </div>
        </div>
      </div>
    </div>
